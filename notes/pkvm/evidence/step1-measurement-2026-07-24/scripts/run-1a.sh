#!/bin/bash
# ============================================================================
# Step 1A — pKVM EL2-coverage bridge A/B baseline (N90, NO kernel rebuild)
#
...
HYP_START=0xffff800081d88ed4     # __hyp_text_start
HYP_END=0xffff800081de8000       # __hyp_text_end
BR_START=0xffff8000800cb848      # pkvm_cov_runtime_to_link .. pkvm_cov_end
BR_END=0xffff8000800cbcc8
UART_START=0xffff800081105708    # amba-pl011 non-init text
UART_END=0xffff80008110e000
