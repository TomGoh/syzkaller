...
var linuxSyscallChecks = map[string]func(*checkContext, *prog.Syscall) string{
	...
	"syz_kvm_dirty_log_cycle":       linuxSyzKvmSupported,
	"syz_kvm_run_protected_guest":   linuxSyzKvmSupported,
	"syz_kvm_pvm_info":              linuxSyzKvmSupported,
...
func linuxSyzKvmSupported(ctx *checkContext, call *prog.Syscall) string {
	...
	case "syz_kvm_setup_cpu$arm64", "syz_kvm_setup_syzos_vm$arm64", "syz_kvm_add_vcpu$arm64",
		...
		"syz_kvm_memslot_reject_flags$arm64", "syz_kvm_dirty_log_cycle$arm64",
		"syz_kvm_run_protected_guest$arm64",
		"syz_kvm_pvm_info$arm64", "syz_kvm_set_fw_ipa$arm64", "syz_kvm_set_fw_ipa_busy$arm64",
		"syz_kvm_run_fw_fault$arm64", "syz_kvm_run_fw_fault_gen$arm64",
